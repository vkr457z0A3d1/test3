...
namespace Duplicati.Library.Main
{
    ...
    public class Options
    {
        ...
        /// </summary>
        private readonly int DEFAULT_FILEPROCESSORS = Math.Max(1, Environment.ProcessorCount / 2);
        ...
        public IList<ICommandLineArgument> SupportedCommands
        {
            get
            {
                var lst = new List<ICommandLineArgument>(new ICommandLineArgument[] {
                    ...
                    new CommandLineArgument("concurrency-fileprocessors", CommandLineArgument.ArgumentType.Integer, Strings.Options.ConcurrencyfileprocessorsShort, Strings.Options.ConcurrencyfileprocessorsLong, DEFAULT_FILEPROCESSORS.ToString()),
