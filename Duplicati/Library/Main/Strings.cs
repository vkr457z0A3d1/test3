...
namespace Duplicati.Library.Main.Strings
{
    ...
    internal static class Options
    {
        ...
        public static string ConcurrencyfileprocessorsLong { get { return LC.L(@"Use this option to set the number of concurrent files to open. This will accelerate big backups involving lot of files, such as an initial backup"); } }
